        ...
        report = {
            ...
            "optional_features": {
                "ping_protocol": {
                    ...
                    "response_time_ms": ping_result.get("response_time_ms") if ping_result else None,
                    "error": ping_result.get("error") if ping_result else None
                },
                "error_compliance": {
                    "tested": error_compliance is not None,
                    "invalid_method_test": error_compliance.get("invalid_method_test", {}) if error_compliance else {},
                    "malformed_request_test": error_compliance.get("malformed_request_test", {}) if error_compliance else {},
                    "compliance_issues": error_compliance.get("compliance_issues", []) if error_compliance else []
                }
            },
            "security_analysis": {
